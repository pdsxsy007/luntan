...
public class ManagerTieAdapter extends CommonAdapter<ArticleBean.Data> {
    Context mContext;
    MyDBHelper myDBHelper ;

    public ManagerTieAdapter(Context context, int layoutId, List<ArticleBean.Data> datas) {
